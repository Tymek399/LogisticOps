...
public class TransportSetController {
    ...
    @GetMapping
    public ResponseEntity<List<TransportSet>> getAllTransportSets() {
        return ResponseEntity.ok(transportSetService.getAllTransportSets());
    }
    
    @GetMapping("/{id}")
    public ResponseEntity<TransportSet> getTransportSetById(@PathVariable Long id) {
    ...
    @PostMapping
    public ResponseEntity<TransportSet> createTransportSet(@RequestBody Map<String, Object> request) {
    ...
    @PostMapping("/{id}/obstacles")
    public ResponseEntity<TransportSet> addObstacle(@PathVariable Long id, @RequestBody Infrastructure infrastructure) {
        return ResponseEntity.ok(transportSetService.addObstacle(id, infrastructure));
    }
